...
static gridd_filter M2V2_PREPARE_CONTAINER_SHARDING_FILTERS[] =
{
	meta2_filter_extract_header_url,
	meta2_filter_extract_admin,
	meta2_filter_extract_user_agent,
...
meta2_gridd_get_v2_requests(void)
{
	...
	static struct gridd_request_descr_s descriptions[] = {
		...
		/* container sharding */
		{NAME_MSGNAME_M2V2_PREPARE_CONTAINER_SHARDING, (hook) meta2_dispatch_all, M2V2_PREPARE_CONTAINER_SHARDING_FILTERS},
